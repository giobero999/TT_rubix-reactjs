                        ...
                        <div>
                            ...
                            <Form onSubmit={this.handleSubmit}>
                              ...
                              <FormGroup>
                                <InputGroup md>
                                  ...
                                  <Select id='dropdownselect' ref='country' defaultValue='1'>
                                    <option value='1'>Georgia</option>
                                    <option value='2'>England</option>
                                    <option value='4'>Azerbaidjan</option>
                                    <option value='5'>Armenia</option>
                                  </Select>
                                   <InputGroupAddon>
                                    <Icon glyph='icon-fontello-asterisk' />
                                  </InputGroupAddon>
                                  <Select id='dropdownselect' ref='city' defaultValue='1'>
                              ...
                              <FormGroup>
                                ...
                                <InputGroup md>
                                  ...
                                  <Input type='text' class="textfield" id = 'phone' ref='phone' className='border-focus-blue' placeholder='Phone' onkeypress="return isNumber(event)"  />
                              ...
                              <FormGroup>
                                <InputGroup md>
                                  ...
                                  <span id="confirmMessage" class="confirmMessage" onpaste="return false;" ></span>
                                </InputGroup>
                              </FormGroup>
                          ...
                          <div className='bg-hoverblue fg-black50 text-center' style={{padding: 25, paddingTop: 12.5}}>
                            ...
                            <div style={{marginTop: 25}}>
                              Already have an account? <Link to='/app/login'>Loginn</Link>
                            </div>
                          </div>
                        </div>
                      </PanelBody>
